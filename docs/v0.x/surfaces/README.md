...
- [v0.x CLI](./cli.md) covers current durable CRUD, settlement, mailbox, acknowledgement, namespaced work metadata, and artifact resolution. It also records unavailable future M2 inspection.
