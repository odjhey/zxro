...
| Immutable implementation-head suite | Last code-bearing commit `3ee11e4`; [GitHub Actions run 32753520325](https://github.com/odjhey/zxro/actions/runs/32753520325) passed Python 3.11 and 3.12 on Ubuntu and macOS |
