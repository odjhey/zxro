...
| Immutable implementation-head suite | Last code-bearing commit `cb17cd5`; [GitHub Actions run 32752069539](https://github.com/odjhey/zxro/actions/runs/32752069539) passed Python 3.11 and 3.12 on Ubuntu and macOS |
