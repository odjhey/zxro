...
updated_at: "2026-08-25T00:41:00+08:00"
---
...
- [x] Immutable implementation-head evidence is recorded for the last code-bearing commit `cb17cd5`: Python 3.11 and 3.12 across Ubuntu and macOS passed in [run 32752069539](https://github.com/odjhey/zxro/actions/runs/32752069539).
